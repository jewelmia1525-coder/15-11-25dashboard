            ...
            <main className="flex-grow bg-base-200 border border-primary/20 rounded-2xl flex flex-col p-4 overflow-hidden">
                ...
                <div className="flex-shrink-0 pt-4 border-t border-primary/20">
                    ...
                    <form onSubmit={handleSubmit} className="flex gap-2">
                        ...
                        />
                        <button id="finance-helper-ask-button" type="submit" className="px-6 py-3 bg-primary text-primary-content font-bold rounded-lg hover:bg-primary-focus transition-all disabled:opacity-50" disabled={!location || isLoading || !query}>
                            Ask
                        </button>
                    </form>
                </div>
