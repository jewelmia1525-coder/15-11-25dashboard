            ...
            <div className="max-h-96 overflow-y-auto space-y-3 pr-2">
                {sortedAndFilteredTransactions.length > 0 ? (
                    ...
                    <div className="text-center py-12 text-muted-content">
                        ...
                        <h3 className="mt-4 text-lg font-semibold text-base-content font-bangla">এখনো কোনো লেনদেন নেই</h3>
                        <p className="mt-1 text-sm font-bangla">আপনার প্রথম লেনদেন যোগ করে শুরু করুন।</p>
                         <button
                            onClick={onAddTransaction}
                            className="mt-6 px-5 py-2.5 bg-primary text-primary-content font-bold rounded-lg hover:bg-primary-focus transition-all text-sm"
                        >
